...
\cite{clarkeHandbookModelChecking2018}
...
% Put some table here with the experiment
\begin{table}
\centering
\begin{tabular}{|c || c | c | c | c|}
 \hline
 Use case & Prop (1) & Prop (2) & Prop (3) & Prop (4) \\
 \hline\hline
 With 2 buses & & & & \\
 \hline
 With 3 buses & & & & \\
...
The Maude LTL model-checker has similar performance as the SPIN model checker. %cite real-time paper.
...
Partial-order reduction in Maude? The potential for state space reduction is huge, especially for model-checking concurrent systems.
% There is at least a theoretical paper about this.
% Partial order reduction already implemented in maude?
% Ask paco.
