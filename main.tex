...
\begin{tabular}{|c || c | c | c |}
 ...
 \hline
\end{tabular}
\caption[Full state space exploration time in Maude]{Full state space exploration time in Maude\footnotemark}
...
\begin{tabular}{|c || c | c | c |}
 ...
 \hline
\end{tabular}
\caption[Full state space exploration time in Groove]{Full state space exploration time in Groove}
\label{table:grooveRuntime}
\end{table}

% Discuss the results and talk about ways to mitigate state space explosion.
The results in \autoref{table:maudeRuntime} were obtained without applying any optimization techniques.
