...
So far, we do not see any problems with this assumption since behavioral modeling language must have some construct to describe state-change.
...
TODO: Describe Maude and possibly also the Groove implementation.
