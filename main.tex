...
A detailed formal description of graph transformation systems can be found in \cite{}. 

We generate typed graph transformation systems, where the \gls*{srm} including the snapshot metamodels is the type graph since it fits rules changing the global state.
...
Together with a system configuration, i.e., start graph, the set of typed rules results in a graph transformation system generating a state space.
