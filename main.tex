...
% TODO: Include after acceptance and helpful feedback.
...
In addition, each local higher-order \gls*{mt} must keep traces of the generated rules.
...
The benchmarks include start-up times, for example, Groove reports the state space exploration for the \textsf{No Buses} taking only \textasciitilde 500ms.
Thus, most of the exploration time in Groove for the \textsf{No Buses} scenario is attributed to the start-up time.
