...
Such a collection of interrelated models is referred to as a \emph{multi-model} \cite{boronatWhatMultimodelingLanguage2009}, which is usually heterogeneous, meaning it consists of models conforming to different modeling languages.
...
For example, multi-models consisting of different interacting behavioral models are found when modeling embedded and cyber-physical systems \cite{varalarsenBehavioralCoordinationOperator2015}.
...
Our approach facilitates specifying \emph{interactions} between multiple potentially heterogeneous behavioral models, which are used to generate a specification of the global behavior.
