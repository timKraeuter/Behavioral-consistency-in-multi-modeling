...
\begin{tabular}{|c || c | c | c |}
 ...
 \hline
\end{tabular}
\caption[Full state space exploration time in Maude]{State space exploration time in Maude\footnotemark}
...
\begin{tabular}{|c || c | c | c |}
 ...
 \hline
\end{tabular}
\caption[Full state space exploration time in Groove]{State space exploration time in Groove}
