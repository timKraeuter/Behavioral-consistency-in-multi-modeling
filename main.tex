...
For example, the TJunction controller must decide when the traffic lights A, B, and C switch states.
...
\begin{figure}[ht!]
    ...
    \caption{Overview of all concepts and their example usage}
