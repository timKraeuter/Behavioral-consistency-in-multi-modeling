...
Nonetheless, they do not apply their approach to heterogeneous models as we deal with in the use case.
...
While both approaches can deal with arbitrary many behavioral models, they focus on simulation rather than consistency or model-checking.
...
% I think Ptolemy fits this. In addition fmi/fmu. check leroy paper
