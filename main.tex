...
Two interactions are not allowed to have overlapping state changing elements (see \cref{eq:noOverlap}).
...
\begin{equation} \label{eq:noOverlap}
    ...
    & \quad (i_1.parts.elements \cup i_1.interactionHost) \\
    & \quad \qquad \cap \\
    & \quad (i_2.parts.elements \cup i_2.interactionHost) \\
    & \quad \qquad = \emptyset
    \end{aligned}
\end{equation}
