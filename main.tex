...
These tasks are typically done by a language engineer which may be a different person than the modeler who uses our consistency management approach.
...
Co-Simulation aims to solve this challenge by composing the simulation of a systems parts into a global simulation \cite{gomesCoSimulationSurvey2019}.
...
% Conclusion
Our work represents a formalization of behavioral consistency management in a heterogeneous modeling scenario, enabling formulating and checking \textit{global} properties.
