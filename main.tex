...
Our approach is independent of the particular formalism used to represent the global behavior, and we currently support graph transformations (Groove) and rewriting logic (Maude).
\end{abstract}
